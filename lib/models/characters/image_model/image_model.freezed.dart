...
class _$ImageModelImpl extends _ImageModel {
  const _$ImageModelImpl({required this.path, required this.extension})
      : super._();
  ...
  @override
  String toString() {
    return 'ImageModel(path: $path, extension: $extension)';
  }
...
abstract class _ImageModel extends ImageModel {
  const factory _ImageModel(
      ...
      required final String extension}) = _$ImageModelImpl;
